...
def set_world(world_args):
    ...
    return t_now, t_max, dt, r, sig2, eZ, S0
...
def vec_rollforward(world_args, t_begin, t_end, A, ec):
  ...
  t_now, t_max, dt, r, sig2, eZ, S0 = set_world(world_args)
...
def delta(world_args, bump_size, contract, *args):
  ...
  up_args = t_now, t_max, dt, r, sig2, eZ_up, S0
  ...
  down_args = t_now, t_max, dt, r, sig2, eZ_down, S0
...
def rho(world_args, bump_size, contract, *args):
  ...
  up_args = t_now, t_max, dt, r_up, sig2, eZ_up, S0
  
  value_up, na1, na2 = contract(up_args, *args)
  
  r_down = r - bump
  eZ_down = eZ * np.exp(-bump * dt)
  down_args = t_now, t_max, dt, r_down, sig2, eZ_down, S0
  value_down, na1, na2 = contract(down_args, *args)
...
def make_future_gen(world_args, N = None):
  ...
  while N is None or count < N :
    ...
    if no_hist:
      ...
      yield t_now, t_max, dt, r, sig2, neZ, S0
...
def bump_S(world_args, bump_size):
  ...
  return t_now, t_max, dt, r, sig2, eZ_bump, S0
...
def bump_r(world_args, bump_size):
  ...
  return t_now, t_max, dt, r_bump, sig2, eZ_bump, S0
